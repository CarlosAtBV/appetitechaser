...
font = ImageFont.truetype(dir_path+"/Firjar-ExtraBold.ttf", 128)
...
for ltr in letters:
	...
	draw.text((4,4), ltr, fill=(0,0,0), font=font)
	...
	outPath = dir_path+f"/../../../TSP PK3/fonts/tsphud_small/{ord(ltr):04x}.png"
	img.save(outPath)
	print(ltr)