...
render_fetus2021.set_path("//../../../TSP PK3/sprites/bh/combostone/");
...
for curFrame in range(scene.frame_start, scene.frame_end+1):
	scene.timeline_markers.new("BHCS"+chr(65 + curFrame)+"0", frame=curFrame);
...
for curFrame in range(scene.frame_start, scene.frame_end+1):
	scene.timeline_markers.new("BHCF"+chr(65 + curFrame)+"0", frame=curFrame);
